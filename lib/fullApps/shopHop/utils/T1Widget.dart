...
Text formHeading(var label) {
  return Text(label, style: TextStyle(color: Color.fromRGBO(0, 86, 98,1), fontSize: 20, fontFamily: 'Bold'), textAlign: TextAlign.center);
}

Text formSubHeadingForm(var label) {
  return Text(label, style: TextStyle(color: Color.fromRGBO(0, 86, 98,1), fontSize: 20, fontFamily: 'Medium'), textAlign: TextAlign.center);
}

Text formSubHeading1Form(var label) {
  return Text(label, style: TextStyle(color: Color.fromRGBO(0, 86, 98,1), fontSize: 14, fontFamily: 'Medium'), textAlign: TextAlign.center);
}
